...
{
    public partial class FrmPostionList : Form
    {
        public FrmPostionList()
        {
            InitializeComponent();
        }
        ...
        {
            DialogResult result = MessageBox.Show("Are you sure about deleting this Position", "Warning", MessageBoxButtons.YesNo);
        ...
        private void FrmPostionList_Load(object sender, EventArgs e)
        {
            FillGrid();
